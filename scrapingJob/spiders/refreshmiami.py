...
class RefreshmiamiSpider(scrapy.Spider):
    name = 'refreshmiami'
    allowed_domains = ['www.refreshmiami.com','refreshmiami.com']
    

    def start_requests(self):
        yield scrapy.Request(f'https://www.refreshmiami.com/jobs/?search_keywords={self.job}')
    ...
    def parse(self, response):
        ...
        link_cont_elemts  = response.xpath('//ul[@class="job_listings"]//a')
